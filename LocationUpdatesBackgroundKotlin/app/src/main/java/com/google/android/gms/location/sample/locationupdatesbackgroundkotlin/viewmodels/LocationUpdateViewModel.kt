...
/**
 * Allows Fragment to observer {@link MyLocation} database, follow the state of location tracking,
...
class LocationUpdateViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val trackingLocation: LiveData<Boolean> = locationRepository.trackingLocation
