 ...
 *
 * IMPORTANT NOTE: You should generally prefer 'while-in-use' location tracking, i.e., tracking
 * location while the app is in use and create a foreground service (tied to a Notification) when
 * the user navigates away from the app. To learn how to do that instead, review the
